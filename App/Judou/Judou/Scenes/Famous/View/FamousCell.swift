...
class FamousCell: UITableViewCell {
    ...
    func createFamousCell(_ famousModel: FamousModel) -> Void {
        ...
        if famousModel.isSubscribe == false {
        ...
        nameLabel.text = famousModel.name
        ...
        introductLabel.text = famousModel.introduction
